...
let AjSensibilisationComponent = class AjSensibilisationComponent {
    constructor(sensibilisationService, _formBuilder, router, route) {
    ...
    save() {
        this.sensibilisationService.saveSensibilisation(this.sensibilisation, this.listeFichier)
            .subscribe(data => {
            this.router.navigate(['administration/list-sensibilisation']);
            console.log(data);
        }, error => {
            console.log(error);
        });
    ...
    selectFile(event) {
        ...
        let nom = event.target.files.item(0).name;
        for (let i = 0; i < this.selectedFiles.length; i++) {
            this.listeFichier.push(this.selectedFiles.item(i));
        }
    }
};
AjSensibilisationComponent.ctorParameters = () => [
...
let AjoutDepistageComponent = class AjoutDepistageComponent {
    constructor(depistageService, authService) {
    ...
    EnregisterDepistage(fo) {
        console.log(fo);
        const depistage = new src_app_models_Depistage_model__WEBPACK_IMPORTED_MODULE_2__["Depistage"]();
        ...
        this.depistageService.SaveDepistage(depistage, this.listeFichier).subscribe(reponse => {
...
AjoutDepistageComponent.ctorParameters = () => [
...
let AjouterUtilisateurComponent = class AjouterUtilisateurComponent {
    ...
    EnregisterUtilisateur(fo) {
        console.log(fo);
        const user = new src_app_models_Utilisateur_model__WEBPACK_IMPORTED_MODULE_3__["Utilisateur"]();
        ...
        if (fo.value.pass1 == fo.value.pass2) {
            ...
            this.utilisateurService.SaveUtilisateur(user).subscribe(reponse => {
                if (reponse != null) {
                    location.href = 'administration/list-utilisateur';
                }
                else {
...
AjouterUtilisateurComponent.ctorParameters = () => [
...
let FormationComponent = class FormationComponent {
    ...
    EnregisterFormation(fo) {
        console.log(fo);
        const formation = new src_app_models_Formation_model__WEBPACK_IMPORTED_MODULE_2__["Formation"]();
        ...
        this.formationService.saveFormation(formation, this.listeFichier).subscribe(reponse => {
            console.log(reponse);
...
let GaleryComponent = class GaleryComponent {
    constructor(galleryService, _formBuilder, router, route) {
    ...
    save() {
        ...
        this.galleryService.saveGallery(this.gallery, this.listeFichier)
            ...
            this.router.navigate(['administration/list-gallery']);
            console.log(data);
        }, error => {
            console.log(error);
        });
...
let ListDepistageComponent = class ListDepistageComponent {
    constructor(depistageService, authService) {
        this.depistageService = depistageService;
        this.authService = authService;
    }
    ...
    GetListDepistage() {
        this.depistageService.GetDepistage().subscribe(reponse => {
            this.depistages = reponse;
        }, error => {
            console.log(error);
        });
    }
    SupprimerDepistage(element) {
        this.depistageService.DeleteDepistage(element.depistage.id).subscribe(reponse => {
...
ListDepistageComponent.ctorParameters = () => [
...
let ListFormationComponent = class ListFormationComponent {
    constructor(formationService, router) {
        this.formationService = formationService;
        this.router = router;
    }
    ngOnInit() {
    ...
    GetListFormation() {
        this.formationService.GetFormation().subscribe(reponse => {
    ...
    SupprimerFormation(element) {
        const formation = element.formation;
        this.formationService.DeleteFormation(element.formation.id).subscribe(reponse => {
...
ListFormationComponent.ctorParameters = () => [
...
let ListGaleryComponent = class ListGaleryComponent {
    constructor(_formBuilder, galleryService, router, route) {
        this._formBuilder = _formBuilder;
        this.galleryService = galleryService;
        this.router = router;
        this.route = route;
    ...
    reloadData() {
        //pour la liste 
        this.galleryService.getGallerysList().subscribe(data => {
            this.data = data;
...
ListGaleryComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
let ListSoinComponent = class ListSoinComponent {
    constructor(_formBuilder, soinService, router, route) {
        this._formBuilder = _formBuilder;
    ...
    reloadData() {
        //pour la liste 
        this.soinService.getSoinsList().subscribe(data => {
            this.data = data;
            //alert(this.data.chemin);
        });
    }
    deleteSoin(id) {
        this.soinService.deleteSoin(id).subscribe(data => {
            console.log(data);
            this.reloadData();
        }, error => console.log(error));
        alert("supprimer avec succes");
...
ListSoinComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
let ListeUtilisateurComponent = class ListeUtilisateurComponent {
    constructor(utilisateurService, authService) {
        this.utilisateurService = utilisateurService;
        this.authService = authService;
    ...
    AffecteElement(utilisateur) {
        this.user = utilisateur;
        console.log(this.user);
    }
    AffecteElementEdit(utilisateur) {
        this.userMod = utilisateur;
    }
    GetListUtilisateur() {
        this.utilisateurService.GetListUser().subscribe(reponse => {
    ...
    SupprimerUtilisateur() {
        ...
        this.utilisateurService.DeleteUtilisateur(this.user.id).subscribe(reponse => {
            this.GetListUtilisateur();
        }, error => {
...
ListeUtilisateurComponent.ctorParameters = () => [
    { type: src_app_services_utilisateurs_service__WEBPACK_IMPORTED_MODULE_2__["UtilisateursService"] },
    { type: src_app_services_authentification_service__WEBPACK_IMPORTED_MODULE_4__["AuthentificationService"] }
];
...
let LoginComponent = class LoginComponent {
    ...
    Authentifier(fo) {
        const utilisat = new src_app_models_users_model__WEBPACK_IMPORTED_MODULE_6__["Users"]();
        utilisat.username = fo.value.username;
        utilisat.password = fo.value.password;
        this.authService.LoginUser(utilisat).subscribe(response => {
...
let SensibilisationComponent = class SensibilisationComponent {
    constructor(_formBuilder, sensibilisationService, router, route) {
        this._formBuilder = _formBuilder;
        this.sensibilisationService = sensibilisationService;
        this.router = router;
        this.route = route;
    ...
    reloadData() {
        this.sensibilisationService.getSensibilisationsList().subscribe(data => {
            this.data = data;
...
let SoinComponent = class SoinComponent {
    constructor(soinService, _formBuilder, router, route) {
        this.soinService = soinService;
        this._formBuilder = _formBuilder;
        this.router = router;
        this.route = route;
    ...
    save() {
        ...
        this.soinService.saveSoin(this.soin, this.listeFichier)
            ...
            this.router.navigate(['administration/list-soin']);
            console.log(data);
        }, error => {
            console.log(error);
        });
...
let DepistageComponent = class DepistageComponent {
    constructor(depistageService) {
        this.depistageService = depistageService;
    }
    ngOnInit() {
        this.GetListDepistage();
    ...
    GetListDepistage() {
        this.depistageService.GetDepistage().subscribe(reponse => {
            this.depistages = reponse;
            for (let elt of this.depistages) {
...
DepistageComponent.ctorParameters = () => [
    { type: src_app_services_depistage_service__WEBPACK_IMPORTED_MODULE_2__["DepistageService"] }
];
...
let Footer1Component = class Footer1Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let FormationsComponent = class FormationsComponent {
    ...
    GetListFormation() {
        this.formationService.GetFormation().subscribe(reponse => {
            this.formations = reponse;
            for (let elt of this.formations) {
...
let GallerysComponent = class GallerysComponent {
...
GallerysComponent.ctorParameters = () => [
    { type: src_app_services_gallery_service__WEBPACK_IMPORTED_MODULE_4__["GalleryService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let PwebComponent = class PwebComponent {
    constructor() { }
    ngOnInit() {
...
let SensiblisaComponent = class SensiblisaComponent {
    constructor(sensibilisationService, router, route) {
        this.sensibilisationService = sensibilisationService;
        this.router = router;
        this.route = route;
...
SensiblisaComponent.ctorParameters = () => [
...
let SoinsComponent = class SoinsComponent {
    constructor(soinService, router, route) {
        this.soinService = soinService;
        this.router = router;
        this.route = route;
...
let MenuAdminComponent = class MenuAdminComponent {
    ...
    UpdateUtilisateur(fo) {
        let utilisateur = new _models_Utilisateur_model__WEBPACK_IMPORTED_MODULE_3__["Utilisateur"]();
        utilisateur.login = this.user;
        if (fo.value.pass1 == fo.value.pass2) {
            utilisateur.password = fo.value.pass1;
            this.userService.UpdatePassword(utilisateur).subscribe(reponse => {
...
let DepistageService = class DepistageService {
    constructor(http) {
        this.http = http;
        this.url = 'api/depistage';
        this.token = localStorage.getItem('token');
    }
    SaveDepistage(dep, file) {
        const formdata = new FormData();
        for (let i = 0; i < file.length; i++) {
            formdata.append('files', file[i]);
        }
        const dateD = dep.dateDebut + "";
        const dateF = dep.dateFin + "";
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', this.url + "/save", formdata, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.token }) });
...
DepistageService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let FormationService = class FormationService {
    ...
    saveFormation(formation, file) {
        const formdata = new FormData();
        for (let i = 0; i < file.length; i++) {
            formdata.append('files', file[i]);
        }
        const dateD = formation.dateDebut + "";
        const dateF = formation.dateFin + "";
...
let GalleryService = class GalleryService {
    ...
    saveGallery(gallery, file) {
        ...
        headers.set("Authorization", this.token);
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', "api/gallery/save", formdata, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.token }) });
        req.responseType, 'json';
        req.reportProgress, true;
        console.log(req);
        return this.http.request(req);
...
headers.set("Access-control-Allow-Origin", "*");
headers.append("Content-Type", "multipart-form-data");
let SensibilisationService = class SensibilisationService {
    constructor(http) {
        this.http = http;
        this.token = localStorage.getItem('token');
    ...
    // fonction agui
    saveSensibilisation(sensibilisation, file) {
        const formdata = new FormData();
        for (let i = 0; i < file.length; i++) {
            formdata.append('files', file[i]);
        }
        const dateD = sensibilisation.datePublication + "";
        ...
        headers.set("Authorization", this.token);
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', "api/sensibilisation/save", formdata, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.token }) });
        req.responseType, 'json';
        req.reportProgress, true;
        console.log(req);
        return this.http.request(req);
    ...
    getSensibilisationsList() {
        //headers.set("Authorization",this.token);
        return this.http.get('api/sensibilisation/list');
    }
};
SensibilisationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
headers.set("Access-control-Allow-Origin", "*");
headers.append("Content-Type", "multipart-form-data");
let SoinService = class SoinService {
    constructor(http) {
        this.http = http;
        this.token = localStorage.getItem('token');
    }
    ...
    saveSoin(soin, file) {
        ...
        headers.set("Authorization", this.token);
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', "api/soin/save", formdata, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.token }) });
        req.responseType, 'json';
        req.reportProgress, true;
        console.log(req);
        return this.http.request(req);
...
UtilisateursService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
